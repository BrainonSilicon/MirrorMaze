...
public class DrawManager : MonoBehaviour
{
    ...
    [SerializeField] // exposes a private variable in the inspector so I can edit it 
    ...
    public void Draw(Vector3 drawPosition)
    {
        ...
        {
            PenLine line = new PenLine(lineSettings); // PenLine has public line seetings - we pass the settings that we set in the inspector to the PenLine
